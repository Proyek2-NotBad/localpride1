...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?= base_url('assets_admin/') ?>plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
    ...
    <!-- iCheck -->
    <script src="<?= base_url('assets_admin/') ?>plugins/iCheck/icheck.min.js"></script>
