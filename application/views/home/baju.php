...
<head>
  ...
  <link href="css/style.css" rel="stylesheet"><header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="index.html"><img src="<?= base_url('assets_web/') ?>img/log.png" alt="" title="" /></img></a>
  ...
  <!-- <section id="portfolio">
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12">
          <h3 class="section-title">Katalog Baju</h3>
      ...
      <div class="row">
        <div class="col-md-3">
          <a class="portfolio-item" <img src = "<? php echo base_url("img/7.jpg")?> href="">
            <div class="details">
              <h4>Portfolio 1</h4>
